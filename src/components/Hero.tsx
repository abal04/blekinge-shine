  ...
  return (
    <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 left-10 w-48 h-48 bg-white/5 rounded-full blur-2xl animate-float" style={{ animationDelay: "1s" }} />
        <div className="absolute top-1/2 left-1/4 text-white/20 animate-float" style={{ animationDelay: "0.5s" }}>
          <Sparkles size={40} />
        </div>
        <div className="absolute top-1/3 right-1/4 text-white/15 animate-float" style={{ animationDelay: "1.5s" }}>
          <Sparkles size={30} />
        </div>
      </div>
      ...
      <div className="container relative z-10 pt-24 pb-16">
        <div className="max-w-3xl mx-auto text-center text-primary-foreground">
          ...
          <p className="text-lg sm:text-xl text-white/85 mb-8 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-white/90 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            {[
              "RUT-avdrag godkänt",
              "Fasta priser",
              "Kvalitetsgaranti",
